# `lookup_crate` session review

## Iteration 1
Parameters:
```json
{"crateName":"godot","version":"0.4.5"}
```
Output:
```text
# Crate: godot v0.4.5
...
## Modules
- **__docs**: # Extended documentation
- **init**: Entry point and global init/shutdown of the library.
- **register**: Register/export Rust symbols to Godot: classes, methods, enums...
- **prelude**: Often-imported symbols.
```
